...
class AdminController extends Controller
{
    ...
    public function delete_coupon($coupon_id)
    {
        ...
        if ($id_coupon) {
            ...
            Session::put('message_deleteCoupon', 'Coupon Không Tồn Tại! (Hoặc bạn không có quyền xóa!');
            return Redirect::to('admin.coupons');
        }
        //return Redirect::to('admin.coupons');
    }
    ...
    function delete_admin_blog($blog_id)
    {
        ...
        if ($id_blog) {
            ...
            Session::put('message_update', 'Blog Không Tồn Tại! (Hoặc bạn không có quyền xóa!');
            return Redirect::to('admin.blog');
        }
    }
