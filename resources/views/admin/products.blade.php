                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-info btn-sm" href="/edit-product/{{ $show_Allproducts->product_id }}">
                                        <i class="fas fa-pencil-alt"></i>
                                        Edit
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="/delete-product/{{ $show_Allproducts->product_id }}">
